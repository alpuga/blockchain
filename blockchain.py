...
class Blockchain(object):
    ...
    def register_node(self, address):
        ...
        :param address: <str> Address of node. i.e. 'http://192.168.0.5:5000'
        """
    ...
    def resolve_conflicts(self):
        """
        This is the consensus algorithm, it resolves resolve_conflicts
        by replacing our chain with the longest one in the networkself.
    ...
    def hash(block):
        ...
        # Make sure the dictionary is ordered, or there will be inconsistent
        # hashes
...
def mine():
    ...
    # We must recieve a reward for finding the proofself.
